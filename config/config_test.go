...
func TestSave(t *testing.T) {
	...
	assert.Len(t, cfg.Integrations, 59)
}
...
func TestEnvMapping_ReturnsMapping(t *testing.T) {
	...
	// 37 base integrations + 11 Google Workspace services sharing the
