...
var dispatch = map[mcp.ToolName]handlerFunc{
	...
	mcp.ToolName("github_create_runner_registration_token"):     createRunnerRegistrationToken,
	mcp.ToolName("github_list_org_runners"):                     listOrgRunners,
	mcp.ToolName("github_create_org_runner_registration_token"): createOrgRunnerRegistrationToken,
