...
var tools = []mcp.ToolDefinition{
	...
	// ── Query: Logs ──────────────────────────────────────────────────
	{
		...
		Parameters: map[string]string{
			...
			"filter": "Single filter expression: key op value, e.g. \"severity_text = 'ERROR'\". Only one expression per call.",
	...
	// ── Query: Traces ────────────────────────────────────────────────
	{
		...
		Parameters: map[string]string{
			...
			"filter":  "Single filter expression: key op value, e.g. \"hasError = true\". Only one expression per call; use service param for service filtering.",
	...
	// ── Query: Metrics ───────────────────────────────────────────────
	{
		...
		Parameters: map[string]string{
			...
			"filter":       "Single filter expression: key op value, e.g. \"service_name = 'frontend'\". Only one expression per call.",
