...
var compactResult = compactyaml.MustLoadWithOverlay("signoz", compactYAML, compactyaml.Options{Strict: false})
...
var (
	...
	_ mcp.ToolMaxBytesIntegration    = (*signoz)(nil)
)
...
func (s *signoz) MaxBytes(toolName mcp.ToolName) (int, bool) {
