...
func listDMEvents(ctx context.Context, t *twitter, args map[string]any) (*mcp.ToolResult, error) {
...
func getDMConversation(ctx context.Context, t *twitter, args map[string]any) (*mcp.ToolResult, error) {
...
func sendDM(ctx context.Context, t *twitter, args map[string]any) (*mcp.ToolResult, error) {
	participantID := argStr(args, "participant_id")
	body := map[string]any{
...
func createDMConversation(ctx context.Context, t *twitter, args map[string]any) (*mcp.ToolResult, error) {
