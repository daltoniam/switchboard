...
func TestConfigure_Success(t *testing.T) {
	...
	tw := &xClient{client: ts.Client(), baseURL: ts.URL}
...
func TestConfigure_CustomBaseURL(t *testing.T) {
	...
	tw := &xClient{client: ts.Client(), baseURL: "https://api.x.com/2"}
...
func TestTools_AllHaveXPrefix(t *testing.T) {
	i := New()
	for _, tool := range i.Tools() {
		assert.Contains(t, string(tool.Name), "x_", "tool %s missing x_ prefix", tool.Name)
	}
}
...
func TestExecute_UnknownTool(t *testing.T) {
	tw := &xClient{bearerToken: "test", client: &http.Client{}, baseURL: "http://localhost"}
	result, err := tw.Execute(context.Background(), "x_nonexistent", nil)
...
func TestDoRequest_Success(t *testing.T) {
	...
	tw := &xClient{bearerToken: "test-token", client: ts.Client(), baseURL: ts.URL}
...
func TestDoRequest_APIError(t *testing.T) {
	...
	tw := &xClient{bearerToken: "bad-token", client: ts.Client(), baseURL: ts.URL}
	_, err := tw.get(context.Background(), "/users/me")
	assert.Error(t, err)
	assert.Contains(t, err.Error(), "x API error (401)")
}
...
func TestDoRequest_204NoContent(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
...
func TestArgStr(t *testing.T) {
	r := mcp.NewArgs(map[string]any{"k": "val"})
	assert.Equal(t, "val", r.Str("k"))

	r2 := mcp.NewArgs(map[string]any{})
	assert.Empty(t, r2.Str("k"))
}

func TestArgInt(t *testing.T) {
	r := mcp.NewArgs(map[string]any{"n": float64(42)})
	assert.Equal(t, 42, r.Int("n"))

	r2 := mcp.NewArgs(map[string]any{"n": 42})
	assert.Equal(t, 42, r2.Int("n"))

	r3 := mcp.NewArgs(map[string]any{})
	assert.Equal(t, 0, r3.Int("n"))
}

func TestArgBool(t *testing.T) {
	r := mcp.NewArgs(map[string]any{"b": true})
	assert.True(t, r.Bool("b"))

	r2 := mcp.NewArgs(map[string]any{"b": false})
	assert.False(t, r2.Bool("b"))

	r3 := mcp.NewArgs(map[string]any{})
	assert.False(t, r3.Bool("b"))
}
...
func TestGetTweet(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_get_tweet", map[string]any{"id": "123456"})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestCreateTweet(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_create_tweet", map[string]any{
...
func TestDeleteTweet(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_delete_tweet", map[string]any{"id": "123"})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestSearchRecent(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_search_recent", map[string]any{
		"query": "golang",
	})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestGetUserByUsername(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_get_user_by_username", map[string]any{
		"username": "elonmusk",
	})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestGetFollowing(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_get_following", map[string]any{
		"user_id": "12345",
	})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestFollowUser(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL, userID: "me123"}
	result, err := tw.Execute(context.Background(), "x_follow_user", map[string]any{
...
func TestLikeTweet(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL, userID: "me123"}
	result, err := tw.Execute(context.Background(), "x_like_tweet", map[string]any{
		"tweet_id": "tweet-999",
	})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestGetBookmarks(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL, userID: "me123"}
	result, err := tw.Execute(context.Background(), "x_get_bookmarks", map[string]any{})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestGetList(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_get_list", map[string]any{"id": "list-1"})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestCreateList(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_create_list", map[string]any{
		"name": "My List",
	})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestSendDM(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_send_dm", map[string]any{
...
func TestGetSpace(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_get_space", map[string]any{"id": "space-1"})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestGetUsage(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_get_usage", map[string]any{})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestGetHomeTimeline(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL, userID: "me123"}
	result, err := tw.Execute(context.Background(), "x_get_home_timeline", map[string]any{})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestBlockUser(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL, userID: "me123"}
	result, err := tw.Execute(context.Background(), "x_block_user", map[string]any{
...
func TestRetweet(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL, userID: "me123"}
	result, err := tw.Execute(context.Background(), "x_retweet", map[string]any{
		"tweet_id": "tweet-1",
	})
	require.NoError(t, err)
	assert.False(t, result.IsError)
...
func TestHideReply(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_hide_reply", map[string]any{"id": "reply-1"})
	require.NoError(t, err)
	assert.False(t, result.IsError)
}
...
func TestGetMe(t *testing.T) {
	...
	tw := &xClient{bearerToken: "token", client: ts.Client(), baseURL: ts.URL}
	result, err := tw.Execute(context.Background(), "x_get_me", map[string]any{})
	require.NoError(t, err)
	assert.False(t, result.IsError)
