...
func (t *xClient) Configure(_ context.Context, creds mcp.Credentials) error {
...
func (t *xClient) fetchMe() (string, error) {
...
func (t *xClient) CompactSpec(toolName string) ([]mcp.CompactField, bool) {
	fields, ok := fieldCompactionSpecs[toolName]
	return fields, ok
}

func (t *xClient) Execute(ctx context.Context, toolName string, args map[string]any) (*mcp.ToolResult, error) {
