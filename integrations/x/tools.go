...
var tools = []mcp.ToolDefinition{
	...
	{
		Name: "x_search_all", Description: "Full-archive search across all tweets (requires Pro tier or higher). Use twitter_search_recent for 7-day window instead",
		Parameters: map[string]string{
	...
	// ── Timelines ──────────────────────────────────────────────────
	{
		Name: "x_get_user_tweets", Description: "Get tweets posted by a specific user. Use user_id from twitter_get_user or twitter_get_user_by_username",
		Parameters: map[string]string{
	...
	// ── Users ──────────────────────────────────────────────────────
	{
		Name: "x_get_user", Description: "Get a user by their numeric ID. Use twitter_get_user_by_username if you have a @handle instead",
		Parameters: map[string]string{
			"id":          "User ID",
