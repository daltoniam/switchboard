...
var rawFieldCompactionSpecs = map[string][]string{
	...
	"linear_get_issue": {"issue.id", "issue.identifier", "issue.title", "issue.description", "issue.url", "issue.priority", "issue.estimate", "issue.dueDate", "issue.createdAt", "issue.updatedAt", "issue.state.name", "issue.state.type", "issue.assignee.name", "issue.assignee.email", "issue.labels.nodes[].name", "issue.project.name", "issue.cycle.name", "issue.parent.identifier", "issue.comments.nodes[].id", "issue.comments.nodes[].body", "issue.comments.nodes[].user.name", "issue.comments.nodes[].createdAt"},
	// GQL root: issue { comments { nodes { ... } } }
