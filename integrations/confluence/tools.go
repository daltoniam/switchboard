...
var tools = []mcp.ToolDefinition{
	// ── Spaces ──────────────────────────────────────────────────────
	{
		Name: "confluence_list_spaces", Description: "List all accessible Confluence spaces. Start here to find space IDs for other operations",
	...
	{
		Name: "confluence_get_space", Description: "Get details of a specific space by ID",
		Parameters: map[string]string{"space_id": "Space ID"},
		Required:   []string{"space_id"},
	},
	{
		Name: "confluence_search", Description: "Search Confluence content using CQL (Confluence Query Language). Supports pages, blog posts, comments, and attachments",
	...
	// ── Pages ───────────────────────────────────────────────────────
	{
		Name: "confluence_list_pages", Description: "List pages, optionally filtered by space or title",
	...
	{
		Name: "confluence_get_page", Description: "Get full details of a specific page by ID, including body content",
	...
	{
		Name: "confluence_create_page", Description: "Create a new page in a space",
	...
	{
		Name: "confluence_update_page", Description: "Update an existing page. Requires the current version number (use confluence_get_page to find it)",
	...
	{
		Name: "confluence_delete_page", Description: "Delete a page by ID",
		Parameters: map[string]string{"page_id": "Page ID"},
		Required:   []string{"page_id"},
	},
	{
		Name: "confluence_get_page_children", Description: "Get child pages of a specific page",
	...
	// ── Blog Posts ──────────────────────────────────────────────────
	{
		Name: "confluence_list_blog_posts", Description: "List blog posts, optionally filtered by space or title",
		Parameters: map[string]string{"space_id": "Filter by space ID", "title": "Filter by exact title", "status": "Filter by status: current, trashed, draft (default current)", "cursor": "Pagination cursor from previous response", "limit": "Max results per page (default 25, max 250)", "sort": "Sort order: id, -id, title, -title, created-date, -created-date, modified-date, -modified-date"},
	},
	{
		Name: "confluence_get_blog_post", Description: "Get full details of a specific blog post by ID, including body content",
	...
	{
		Name: "confluence_create_blog_post", Description: "Create a new blog post in a space",
	...
	{
		Name: "confluence_update_blog_post", Description: "Update an existing blog post. Requires the current version number (use confluence_get_blog_post to find it)",
	...
	{
		Name: "confluence_delete_blog_post", Description: "Delete a blog post by ID",
	...
	// ── Comments ────────────────────────────────────────────────────
	{
		Name: "confluence_list_comments", Description: "List footer comments on a page or blog post",
	...
	{
		Name: "confluence_create_comment", Description: "Add a footer comment to a page or blog post",
	...
	{
		Name: "confluence_delete_comment", Description: "Delete a footer comment by ID",
